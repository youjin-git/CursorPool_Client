...
fn main() {
    ...
    Builder::default()
        ...
        .invoke_handler(generate_handler![
            ...
            api::get_disclaimer,
            api::register,
            api::commands::save_history_record,
            api::commands::save_history_records,
            api::commands::get_history_records,
            api::commands::save_history_account,
            api::commands::get_history_accounts,
            api::commands::remove_history_account,
            api::commands::clear_history_accounts,
            reset_machine_id,
            switch_account,
            get_machine_ids,
